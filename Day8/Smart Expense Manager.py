...
e1 = Expense("Dev", 1, 500, "Food", "Lunch", "2026-04-11")
e1.add_expense()

e2 = Expense("Dev", 1, 800, "Travel", "Petrol", "2026-04-12")
e2.add_expense()

e3 = Expense("Dev", 1, 2000, "Shopping", "Jacket", "2026-04-13")
e3.add_expense()

e4 = Expense("Dev", 1, 600, "Food", "Dinner", "2026-04-15")
e4.add_expense()

e1.view_expenses()
e1.filter_by_category("Food")
e1.filter_by_date("2026-04-11")
e1.total_expense()
e1.category_wise_spending()
e1.update_expense(1, 450, "Food", "Lunch Updated", "2026-04-11")
e1.delete_expense(2)
e1.view_expenses()
e1.monthly_report()
e1.highest_expense()
